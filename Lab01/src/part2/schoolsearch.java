    ...
    ****************************************************************************/
    ...
    private static void Search(LinkedList<Student> students, LinkedList<Teacher> teachers, boolean test){
        ...
        while(!inputStr.equals("Q") && !inputStr.equals("Quit") && !inputStr.equals("q") && !inputStr.equals("quit")){
           ...
           /*****************************************************************************
           * Requirement: R7, R9, NR3
           *
           * Description: The Grade Commands (see internals for more specific descriptions)
           ****************************************************************************/
           case "G:":
           case "g:":
           case "Grade:":
                 ...
                 System.out.println("Invalid format for 'G[rade]:' - S[tudent], T[eacher], H[igh], L[ow] not specified");
                  ...
                  switch (mode) {
                      ...
                      case "high" :
                        ...
                        * Requirement: R9
                        *
                        * Description: Lists the highest or lowest GPA in the given grade
                        ****************************************************************************/
                      case "L":
                      case "l":
                      case "Low":
                      ...
                      ****************************************************************************/
                       ...
                       * Requirement: R7
                       *
                       * Description: Lists all students in the specified grade.
                       ****************************************************************************/
                      case "S":
                      case "s":
                      case "Student":
